...
@section('content_header')
    <h1 class="mt-3">Students Violation Management</h1>
    <ol class="breadcrumb mb-2">
        <li class="breadcrumb-item active" href="#" style="cursor: pointer;">Dashboard</li>
        <li class="breadcrumb-item " href="#" style="cursor: pointer;">Violation Setting</li>
    </ol>
    <div class="row mb-3 justify-content-end">
        <div class="col-md-6">
            <div class="position-relative">
                <div class="input-group">
                    <input type="text" id="searchTableInput" class="form-control" placeholder="Search Student Violations...">
...
@section('content')
    ...
    <div class="row">
       <div class="container-fluid">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="text-muted">Student violation counts</a>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="text-muted ">Highiest Violation Fee</a>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a class="text-muted">Lowest Violation Fee</a>
        ...
        {{-- Table for displaying student violations --}}
        <div class="col-12">
            <div class="card">
                ...
                <table class="table table-head-fixed text-nowrap" id="event">
                    ...
                    <tr class="">
                        ...
                        <td class="btn-groups" >
                                <a href="#" class="view-student-violation-modal btn btn-info view-btn shadow"
                                data-id="{{$sv->id}}"
                                ...
                                <a href="#" class="edit-student-violation-modal btn btn-warning edit-btn shadow"
                                data-id="{{$sv->id}}"
                                data-area_code="{{$sv->area_code}}"
                                data-college_id="{{$sv->college_id}}"
                                ...
                                <a href="#" class="delete-student-violation-modal btn btn-danger delete-btn shadow"
                                    data-id="{{$sv->id}}"
                                    data-sid="{{$sv->sid}}"
